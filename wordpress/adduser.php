...
<div class="container bg-light p-3 mt-5">
    <form action="insert_adduser.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group row mt-3">
            <label for="username" class="col-sm-2 col-form-label">Username (Required)</label>
            <div class="col-sm-6">
        ...
        <div class="form-group mt-5">
            <button type="submit" class="btn btn-light col-sm-2" name="submit">Add New User</button>
        </div>
